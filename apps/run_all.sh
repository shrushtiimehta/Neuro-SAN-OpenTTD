...
#
#   ./apps/run_all.sh                          # air, tier 1, stepped
#   ./apps/run_all.sh --mode rail              # rail instead
#   ./apps/run_all.sh --tier t2 --fresh        # tier 2, playbooks reset from their seeds
#   ./apps/run_all.sh --sessions 3             # three sessions back to back, learning between
#
...
# The studio resolves `coded_tools.*` from here and `agents.neuro_san.coded_tools.*` from the
